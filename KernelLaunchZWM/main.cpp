...
#include "acl/acl.h"
#include "aclrtlaunch_sigmoid_custom.h"
...
int32_t main(int32_t argc, char *argv[])
{
    ...
    ICPU_RUN_KF(sigmoid_custom, blockDim, x, z,
                *reinterpret_cast<SigmoidCustomTilingData *>(tiling)); // use this macro for cpu debug
    ...
    ACLRT_LAUNCH_KERNEL(sigmoid_custom)(blockDim, stream,xDevice, zDevice, tiling);
